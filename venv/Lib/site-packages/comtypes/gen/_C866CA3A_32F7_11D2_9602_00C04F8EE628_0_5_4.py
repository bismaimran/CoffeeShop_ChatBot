...
__all__ = [
    'SpeechDisplayAttributes', 'SPFM_NUM_MODES', 'SRESoundEnd',
    'DISPID_SPIEnginePrivateData', 'SDTProperty',
    'DISPID_SOTDisplayUI', 'SPVPRI_NORMAL',
    'DISPID_SLWPronunciations', 'DISPID_SRCERequestUI',
    'DISPID_SOTsCount', 'SPSInterjection', 'SpeechRegistryUserRoot',
    'DISPID_SLWsItem', 'SPBO_TIME_UNITS', 'SPPROPERTYINFO',
    'SPCT_COMMAND', 'SRAInterpreter', 'SGSExclusive', 'SRCS_Enabled',
    'DISPID_SABufferNotifySize', 'SPDKL_LocalMachine',
    'SpNullPhoneConverter', 'SASPause', 'SpCustomStream', 'SPAO_NONE',
    'SPBO_PAUSE', 'SINone', 'SVP_7', 'DISPID_SDKGetStringValue',
    'SVSFIsFilename', 'SAFTADPCM_11kHzMono', 'ISpNotifySource',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SLTApp',
    'DISPID_SPEDisplayText', 'ISpRecognizer', 'DISPID_SLPsCount',
    'DISPID_SRGDictationLoad', 'eLEXTYPE_PRIVATE1',
    'ISpeechGrammarRuleStateTransitions', 'SPEI_HYPOTHESIS',
    'SGPronounciation', 'SpResourceManager',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPEI_SR_AUDIO_LEVEL',
    'SPEI_WORD_BOUNDARY', 'SPSSuppressWord', 'SVP_8', 'SREStreamEnd',
    'SPEI_SOUND_START', 'DISPID_SRDisplayUI', 'SP_VISEME_12',
    'eLEXTYPE_RESERVED6', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SOTCSetId', 'SRERequestUI', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SpeechAudioStatus', 'ISpRecoResult', 'SPCATEGORYTYPE',
    'SAFTADPCM_22kHzMono', 'eLEXTYPE_RESERVED9',
    'SGDSActiveUserDelimited', 'SP_VISEME_21', 'SPPS_RESERVED1',
    'DISPID_SOTRemove', 'eLEXTYPE_RESERVED10', 'DISPID_SDKDeleteKey',
    'DISPID_SVEventInterests', 'DISPID_SRCESoundEnd',
    'DISPID_SGRSTRule', 'ISpeechPhraseInfoBuilder', 'SECFIgnoreWidth',
    'DISPID_SLRemovePronunciation', 'DISPID_SRRGetXMLErrorInfo',
    'SP_VISEME_17', 'SpeechWordPronounceable', 'SP_VISEME_8',
    'SpeechRunState', 'DISPID_SpeechRecoContext', 'eWORDTYPE_DELETED',
    'SGDisplay', 'SVP_13', 'DISPID_SPAPhraseInfo', 'DISPID_SRState',
    'DISPID_SPRulesItem', 'DISPID_SGRSTPropertyId', 'SPSHORTCUTTYPE',
    'eLEXTYPE_PRIVATE12', 'DISPID_SLWsCount', 'DISPID_SASetState',
    'DISPID_SPELexicalForm', 'SDA_Two_Trailing_Spaces',
    'SPAUDIOSTATE', 'SPPS_Unknown', 'DISPID_SPRsItem',
    'SVSFPurgeBeforeSpeak', 'SPBO_AHEAD',
    'SpeechGrammarTagUnlimitedDictation', 'SAFT16kHz8BitStereo',
    'SRTReSent', 'SPWT_DISPLAY', 'DISPID_SRGState', 'DISPID_SVSkip',
    'DISPID_SREmulateRecognition', 'SVP_4', 'SPGRAMMARSTATE',
    'DISPID_SRGDictationUnload', 'ISpEventSink', 'SVSFVoiceMask',
    'DISPID_SASFreeBufferSpace', 'ISpeechRecoContext',
    'SREPhraseStart', 'DISPID_SRCEEnginePrivate', 'SpeechAudioState',
    'SpeechTokenKeyAttributes',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'ISpeechPhoneConverter', 'SPEI_REQUEST_UI', 'ISpeechAudio',
    'SpeechDiscardType', 'SpeechSpecialTransitionType',
    'SPINTERFERENCE_TOOQUIET', 'SPWORDPRONUNCIATIONLIST', 'SGLexical',
    'DISPID_SPRuleFirstElement', 'SVP_0', 'DISPID_SPIReplacements',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVF_Stressed',
    'DISPID_SPPChildren', 'SpVoice', 'DISPID_SPRuleConfidence',
    'SVP_20', 'DISPID_SRRTimes', 'ISpResourceManager',
    'ISpeechPhraseReplacements', 'SVSFNLPSpeakPunc',
    'DISPID_SASState', 'SAFT32kHz16BitStereo', 'ISpStreamFormat',
    'DISPID_SGRSAddRuleTransition', 'eLEXTYPE_RESERVED4',
    'DISPID_SRRSaveToMemory', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRGId', 'DISPID_SOTCId', 'DISPID_SAStatus',
    'ISpXMLRecoResult', 'DISPID_SGRName', 'DISPID_SRCEPhraseStart',
    'SPEI_RESERVED3', 'SP_VISEME_9', 'DISPID_SRRAudio',
    'SpNotifyTranslator', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SRGRules',
    'ISpeechPhraseRule', 'DISPID_SAFType', 'SAFT12kHz8BitMono',
    'SpeechPropertyResponseSpeed', 'SPBINARYGRAMMAR',
    'SPGRAMMARWORDTYPE',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT12kHz16BitMono', 'ISpeechPhraseProperty',
    'SpeechPropertyNormalConfidenceThreshold', 'ISpeechBaseStream',
    'SAFTGSM610_8kHzMono', 'SRAORetainAudio', 'DISPID_SBSSeek',
    'SVP_12', 'SVEBookmark', 'SVEWordBoundary',
    'DISPID_SVIsUISupported', 'DISPID_SVRate', 'SpInprocRecognizer',
    'DISPID_SVWaitUntilDone', 'SRERecoOtherContext',
    'SpeechAudioVolume', 'DISPID_SVSCurrentStreamNumber',
    'ISpeechRecoResultDispatch', 'DISPID_SpeechMemoryStream',
    'SPSHT_EMAIL', 'DISPID_SLPs_NewEnum', 'DISPID_SRCResume',
    'DISPID_SPIAudioStreamPosition', 'SSSPTRelativeToStart',
    'DISPID_SADefaultFormat', 'DISPID_SVResume',
    'SpSharedRecoContext', 'DISPID_SRCCreateResultFromMemory',
    'SPEI_VOICE_CHANGE', 'SAFT22kHz8BitMono', 'SREAllEvents',
    'ISpeechObjectTokens', 'SAFT22kHz8BitStereo',
    'SPPHRASEREPLACEMENT', 'SPGS_ENABLED', 'DISPID_SDKSetBinaryValue',
    'SRSActiveAlways', 'DISPID_SPPNumberOfElements', 'SPSNoun',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRGCmdSetRuleIdState',
    'SVP_14', 'IStream', 'DISPID_SVEVoiceChange',
    'SWPKnownWordPronounceable', 'DISPID_SPRulesCount',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SMSSetData',
    'SAFTCCITT_uLaw_44kHzMono', 'SSFMCreate', 'DISPID_SVAudioOutput',
    'DISPID_SGRSTPropertyName', 'SP_VISEME_11',
    'SDA_One_Trailing_Space', 'SVP_19', 'SpeechTokenKeyFiles',
    'SAFT16kHz8BitMono', 'DISPID_SPEActualConfidence',
    'SpMMAudioEnum', 'SpTextSelectionInformation', 'SP_VISEME_13',
    'SPDATAKEYLOCATION', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPCT_SUB_COMMAND', 'DISPID_SOTCreateInstance',
    'ISpPhoneticAlphabetSelection', 'DISPID_SPILanguageId',
    'DISPID_SDKEnumValues', 'DISPID_SOTSetId', 'DISPID_SGRAddState',
    'SPEI_SOUND_END', 'IInternetSecurityManager',
    'DISPID_SVEBookmark', 'DISPID_SMSALineId', 'DISPID_SGRSTsCount',
    'DISPID_SGRSTsItem', 'DISPID_SRSetPropertyString',
    'SPRST_INACTIVE', 'SPLEXICONTYPE', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SpeechAudioFormat', 'SAFT44kHz16BitMono', 'ISpShortcut',
    'DISPID_SPPName', 'SAFTDefault', 'DISPID_SDKGetBinaryValue',
    'SPCT_SLEEP', 'SPSModifier', 'DISPID_SPRText',
    'SPPS_SuppressWord', 'DISPID_SVAudioOutputStream', 'SPEI_MAX_TTS',
    'DISPID_SGRSTransitions', 'DISPID_SOTGetAttribute',
    'SPCS_ENABLED', 'SPCS_DISABLED', 'SAFT48kHz8BitStereo',
    'SpeechVoicePriority', 'SGDSActive', 'ISpRecoGrammar',
    'DISPID_SVVoice', 'DISPID_SAFGetWaveFormatEx',
    'ISpeechRecoResult', 'DISPID_SPPsItem', 'SPSVerb',
    'DISPID_SPEDisplayAttributes', 'ISpeechCustomStream',
    'ISpObjectWithToken', 'SPRECOCONTEXTSTATUS',
    'DISPID_SRCEEndStream', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechPhraseRule', 'DISPID_SpeechBaseStream',
    'SRTExtendableParse', 'DISPID_SOTs_NewEnum',
    'DISPID_SpeechPhraseProperty', 'SPEI_PHONEME',
    'DISPID_SCSBaseStream', 'SPEI_TTS_AUDIO_LEVEL',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SpeechPhraseElement',
    'DISPID_SGRsAdd', 'DISPID_SpeechGrammarRuleStateTransition',
    ...
    'Speech_StreamPos_RealTime', 'DISPID_SVSLastBookmarkId',
    'DISPID_SWFEBlockAlign', 'DISPID_SPRDisplayAttributes',
    'IEnumSpObjectTokens', 'SPSFunction', 'SREInterference',
    'SPRST_ACTIVE', 'SPEI_END_INPUT_STREAM', 'SPWORD',
    'SSFMOpenForRead', 'DISPID_SLWLangId',
    'DISPID_SRGCmdLoadFromResource', 'SGSEnabled', 'SPEI_MAX_SR',
    'SPAO_RETAIN_AUDIO', 'SDA_Consume_Leading_Spaces',
    'SpeechRecoEvents', 'DISPID_SRGDictationSetState',
    'DISPID_SPCIdToPhone', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SPIElements', 'SAFT8kHz8BitStereo',
    'SAFTADPCM_11kHzStereo', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpeechCategoryVoices', 'SpeechRecognizerState',
    'DISPID_SOTIsUISupported', 'DISPID_SVDisplayUI', 'SSTTDictation',
    'ISpRecognizer3', 'SVEVoiceChange', 'DISPIDSPRG',
    'DISPID_SRIsUISupported', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRRTLength', 'SP_VISEME_20', 'SPEI_RESERVED6',
    'SPGS_DISABLED', 'SGRSTTDictation', 'SpLexicon',
    'DISPID_SpeechDataKey', 'ISpeechDataKey', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRGCmdLoadFromFile', 'SVSFPersistXML',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SRCEAudioLevel',
    'SDA_No_Trailing_Space', 'DISPID_SGRAddResource',
    'DISPID_SPIEngineId', 'DISPID_SRGetFormat', 'LONG_PTR',
    'SRADynamic', 'DISPID_SPRuleName', 'eLEXTYPE_PRIVATE4',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SpeechVoice', 'SVPNormal',
    'DISPID_SFSClose', 'SPPS_Verb', 'ISpeechGrammarRule',
    'DISPID_SRRGetXMLResult', 'DISPID_SRCVoice',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SREPropertyNumChange',
    'eLEXTYPE_PRIVATE14', 'DISPID_SPRNumberOfElements', 'SpShortcut',
    'DISPID_SRSClsidEngine', 'DISPID_SPPsCount',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SpeechAudioBufferInfo',
    'SAFT24kHz16BitStereo', 'SGRSTTRule',
    'DISPID_SVSLastStreamNumberQueued', 'SGLexicalNoSpecialChars',
    'SpeechRetainedAudioOptions', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SpeechAudioProperties', 'eLEXTYPE_PRIVATE20', 'DISPID_SOTId',
    'SP_VISEME_3', 'SPDKL_DefaultLocation', 'DISPID_SABIEventBias',
    'SAFT22kHz16BitStereo', 'DISPID_SVGetAudioInputs',
    'SPGS_EXCLUSIVE', 'DISPID_SOTCategory', 'SPEI_RECOGNITION',
    'SVSFNLPMask', 'SPCONTEXTSTATE', 'SAFTText',
    'DISPID_SLGetGenerationChange', 'DISPID_SGRsCount',
    'DISPID_SLWs_NewEnum', 'SPPS_RESERVED2', 'SVEStartInputStream',
    'DISPID_SPPValue', 'DISPID_SpeechLexiconWords',
    'DISPID_SPISaveToMemory', 'DISPID_SpeechVoiceStatus',
    'ISpeechRecoGrammar', 'SpeechCategoryRecoProfiles',
    'SpPhraseInfoBuilder', 'STCLocalServer', 'SPRECOGNIZERSTATUS',
    'SPSHT_NotOverriden', 'SpeechUserTraining', 'DISPID_SPIGrammarId',
    'DISPID_SGRSTPropertyValue', 'SPAUDIOBUFFERINFO',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SVVolume',
    'DISPID_SGRSTNextState', 'ISpeechPhraseAlternates',
    'ISpPhoneConverter', 'DISPID_SRRAudioFormat',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SRCEInterference',
    'DISPID_SDKSetStringValue', 'SREAudioLevel',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SSFMCreateForWrite',
    'DISPID_SLGetWords', 'DISPID_SGRSTText', 'SVP_5', 'SRAImport',
    'SpeechTokenContext', 'ISpeechPhraseInfo', 'STCRemoteServer',
    'SAFTCCITT_ALaw_11kHzStereo', 'WAVEFORMATEX', 'SPEI_SR_BOOKMARK',
    'SAFT16kHz16BitMono', 'eLEXTYPE_PRIVATE5',
    'DISPID_SGRInitialState', 'SpeechDataKeyLocation',
    'DISPID_SVEStreamEnd', 'DISPID_SRGCmdLoadFromMemory',
    'SpeechEngineConfidence', 'DISPID_SRProfile',
    'SpeechStreamFileMode', 'SREHypothesis', 'SAFTADPCM_44kHzMono',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SRRAlternates',
    'SAFT8kHz16BitMono', 'ISpeechLexiconWord', 'DISPID_SPCPhoneToId',
    'SPXRO_Alternates_SML', 'DISPID_SPPFirstElement',
    'DISPID_SDKOpenKey', 'ISpeechVoiceStatus', 'SAFT11kHz8BitStereo',
    'SpeechGrammarTagDictation', 'SAFT24kHz8BitMono',
    'DISPID_SPCLangId', 'DISPID_SABIMinNotification',
    'STSF_CommonAppData', 'DISPIDSPTSI_ActiveLength', 'eLEXTYPE_USER',
    'DISPID_SPIProperties', 'ISpeechPhraseReplacement',
    'DISPID_SPARecoResult', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SRCAudioInInterferenceStatus', 'SPFM_CREATE_ALWAYS',
    'SpeechCategoryAppLexicons', 'DISPID_SDKDeleteValue',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SASNonBlockingIO',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SRIsShared',
    'SSSPTRelativeToCurrentPosition', 'SECNormalConfidence',
    '__MIDL_IWinTypes_0009', 'SPLO_STATIC', 'DISPID_SRGetRecognizers',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPSUnknown', 'SAFT12kHz8BitStereo',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SABufferInfo',
    'DISPID_SRAudioInput', 'SPEI_PHRASE_START', 'SVP_11',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SWFEFormatTag',
    'DISPID_SWFEBitsPerSample', 'ISpProperties', 'SVP_17',
    'DISPID_SLPSymbolic', 'SAFTCCITT_uLaw_22kHzMono', 'UINT_PTR',
    'SP_VISEME_4', 'ISpeechXMLRecoResult', 'DISPID_SRCEAdaptation',
    'SpPhoneticAlphabetConverter', 'SPEI_RECO_OTHER_CONTEXT',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SpeechLexiconWord',
    'SVSFlagsAsync', 'DISPID_SpeechRecognizerStatus', 'SDTAudio',
    'ISpPhrase', 'DISPID_SRRRecoContext', 'DISPID_SPRFirstElement',
    'SPEI_RECO_STATE_CHANGE', 'SpeechAudioFormatGUIDWave',
    'ISpSerializeState', 'SECFIgnoreKanaType', 'eLEXTYPE_PRIVATE13',
    'SAFT24kHz8BitStereo', 'SRERecognition', 'SVP_3', 'SPVOICESTATUS',
    'SDTDisplayText', 'SREAdaptation', 'SPINTERFERENCE_TOOLOUD',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPSMF_UPS',
    'SGRSTTWord', 'SAFT48kHz8BitMono', 'SGRSTTEpsilon',
    'DISPID_SRGetPropertyNumber', 'eLEXTYPE_VENDORLEXICON', 'SPRULE',
    'tagSPTEXTSELECTIONINFO', 'ISpRecoContext2', 'SFTInput',
    'DISPID_SPACommit', 'SAFTGSM610_22kHzMono',
    'DISPID_SVSpeakStream', 'SAFTADPCM_8kHzStereo',
    'Speech_Default_Weight', 'DISPID_SpeechRecoResult2',
    'DISPID_SpeechRecognizer', 'DISPID_SRRTStreamTime',
    'SPAUDIOOPTIONS', 'SPEI_SENTENCE_BOUNDARY', 'SpeechRuleState',
    'SVSFIsNotXML', 'SpeechGrammarWordType', 'SECFDefault',
    'SPFM_OPEN_READONLY', 'SPWORDLIST', 'DISPID_SRCRetainedAudio',
    'SITooSlow', 'SPEI_RESERVED5', 'SPVPRI_OVER', 'SRAExport',
    'SPTEXTSELECTIONINFO', 'DISPID_SVSPhonemeId',
    'SVSFParseAutodetect', 'SRTStandard', 'SWTAdded',
    'SpeechGrammarState', 'SpObjectToken', 'SPSEMANTICFORMAT',
    'SPPS_Interjection', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPEI_INTERFERENCE', 'SpeechRecoProfileProperties',
    'SpeechTokenKeyUI', 'SPEI_TTS_PRIVATE',
    'ISpPhoneticAlphabetConverter', 'SPAR_High', 'SRAONone',
    'DISPID_SRCreateRecoContext', 'ISpeechPhraseRules',
    'SAFTCCITT_ALaw_44kHzMono', 'SP_VISEME_14', 'ISpAudio', 'SVP_10',
    'SREBookmark', '_ISpeechRecoContextEvents',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SLAddPronunciation',
    'DISPID_SpeechWaveFormatEx', 'SPEI_MIN_TTS',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SRSNumberOfActiveRules',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRCEPropertyNumberChange',
    'SpeechWordType', 'SpeechTokenValueCLSID', 'SRSActive',
    'DISPID_SRGSetTextSelection', 'DISPID_SRCEStartStream',
    'SpeechAudioFormatType', 'SPWAVEFORMATTYPE', 'SPRECORESULTTIMES',
    'ISpNotifyTranslator', 'Speech_Max_Word_Length',
    'DISPID_SPEEngineConfidence', 'SpeechPropertyAdaptationOn',
    'DISPID_SRGetPropertyString', 'SAFTExtendedAudioFormat',
    'DISPID_SVEAudioLevel', 'SINoSignal', 'SpFileStream',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRCESoundStart',
    'DISPID_SPEsCount', 'DISPID_SVAlertBoundary', 'DISPID_SRCState',
    'SAFT44kHz8BitMono', 'DISPID_SpeechGrammarRule',
    'eLEXTYPE_PRIVATE3', 'SpMMAudioIn', 'SVEAudioLevel',
    'SpMMAudioOut', 'ISpeechGrammarRules', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SAVolume', 'SPEI_START_SR_STREAM', 'SBOPause',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SVGetProfiles',
    'SPEI_UNDEFINED', 'SpeechCategoryAudioOut',
    'DISPID_SLGenerationId', 'STSF_AppData', 'SPCT_SUB_DICTATION',
    'DISPID_SRSSupportedLanguages', 'SASRun', 'SITooFast',
    'eLEXTYPE_APP', 'SVP_1', 'SVP_9', 'DISPID_SGRsCommit',
    'SP_VISEME_5', 'SP_VISEME_1', 'SPRULESTATE',
    'DISPID_SLGetPronunciations',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRCEventInterests',
    'ISpeechLexiconPronunciations', 'SpeechCategoryPhoneConverters',
    'SAFT11kHz8BitMono', 'ISpeechPhraseElements',
    'DISPID_SWFEChannels', 'SPSHT_Unknown', 'SVF_Emphasis',
    'SGRSTTTextBuffer', 'SVP_18', 'SDTLexicalForm', 'SPAR_Low',
    'DISPID_SpeechAudio', 'SPAUDIOSTATUS', 'SLTUser',
    'ISpeechMemoryStream', 'SpInProcRecoContext', 'SPLOADOPTIONS',
    'DISPID_SLPPartOfSpeech', 'SWPUnknownWordUnpronounceable',
    'ISequentialStream', 'SpUnCompressedLexicon',
    'eLEXTYPE_PRIVATE17', 'SPWF_SRENGINE', 'DISPID_SLWType',
    'DISPID_SpeechPhoneConverter', 'DISPID_SPIGetText',
    'DISPID_SGRsFindRule', 'DISPID_SGRSAddWordTransition',
    'SPAS_CLOSED', '_RemotableHandle', 'SPRST_INACTIVE_WITH_PURGE',
    'STCInprocServer', 'DISPID_SPEAudioSizeBytes', 'SWTDeleted',
    'DISPID_SRSCurrentStreamPosition', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SRRTOffsetFromStart',
    'ISpeechAudioStatus', 'DISPID_SpeechLexiconPronunciation',
    'SpeechDictationTopicSpelling', 'SDTAll', 'SRARoot',
    'SAFT32kHz16BitMono', 'SpObjectTokenCategory',
    'DISPID_SOTGetDescription', 'SPPHRASEELEMENT', 'SLOStatic',
    'DISPID_SMSGetData', 'SpeechBookmarkOptions', 'SPEI_VISEME',
    'SPINTERFERENCE_TOOSLOW', 'SPVISEMES', 'DISPID_SVGetAudioOutputs',
    'DISPID_SLWWord', 'SpeechCategoryRecognizers', 'SPSHORTCUTPAIR',
    'DISPID_SPIAudioSizeTime', 'SPPHRASEPROPERTY', 'SVPOver',
    'SP_VISEME_16', 'SPSHORTCUTPAIRLIST', 'eLEXTYPE_PRIVATE6',
    'SpeechRuleAttributes', 'SREPrivate',
    'DISPID_SPRuleNumberOfElements', 'SP_VISEME_10',
    'SpeechPartOfSpeech', 'SVF_None', 'SPAS_PAUSE',
    'DISPID_SRCRetainedAudioFormat', 'ISpObjectTokenCategory',
    'DISPID_SpeechCustomStream', 'DISPID_SPRuleParent',
    'SPPARTOFSPEECH', 'DISPID_SGRAttributes', 'ISpeechLexicon',
    'SPRS_INACTIVE', 'eLEXTYPE_MORPHOLOGY', 'SAFT24kHz16BitMono',
    'SPWF_INPUT', 'SpeechPropertyComplexResponseSpeed',
    'SVSFParseMask', 'DISPID_SRCERecognition',
    'DISPID_SpeechPhraseElements', 'SPEVENTENUM',
    'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SPRuleEngineConfidence', 'SDTRule', 'DISPID_SMSAMMHandle',
    'DISPID_SWFEExtraData', 'ISpeechRecognizerStatus',
    'ISpeechObjectTokenCategory', 'DISPID_SVGetVoices',
    'eLEXTYPE_RESERVED8', 'SASClosed',
    'DISPID_SPPBRestorePhraseFromMemory', 'SP_VISEME_0', 'SINoise',
    'SDKLLocalMachine', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SPAs_NewEnum',
    'SP_VISEME_18', 'DISPID_SFSOpen', 'SPVPRI_ALERT',
    'DISPID_SASCurrentSeekPosition', 'SVPAlert',
    'SAFT12kHz16BitStereo', 'ISpMMSysAudio', 'SRESoundStart',
    'DISPID_SPPs_NewEnum', 'SpeechStreamSeekPositionType',
    'ISpObjectToken', 'SpeechInterference', 'SPEI_START_INPUT_STREAM',
    'DISPID_SpeechMMSysAudio', 'SPDKL_CurrentUser', 'ISpEventSource',
    'STCAll', 'SGSDisabled', 'SRSInactive', 'SPSEMANTICERRORINFO',
    'SpeechGrammarTagWildcard', 'ISpeechVoice',
    'SpeechCategoryAudioIn', 'SPPS_LMA', 'DISPID_SVEEnginePrivate',
    '_SPAUDIOSTATE', 'SPSLMA', 'SAFT44kHz8BitStereo',
    'DISPID_SpeechGrammarRuleState', 'ISpeechGrammarRuleState',
    'SpeechVoiceSpeakFlags', 'ISpDataKey', 'SPFILEMODE',
    'SVEAllEvents', 'DISPID_SpeechPhraseProperties',
    'DISPID_SGRs_NewEnum', 'ISpGrammarBuilder',
    'ISpeechPhraseProperties', 'ISpeechAudioFormat', 'SPPS_Function',
    'SAFTGSM610_44kHzMono', 'DISPID_SVSLastBookmark',
    'DISPID_SGRSTType', 'DISPID_SpeechXMLRecoResult',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SVSInputSentencePosition', 'SECFEmulateResult',
    'DISPID_SRAudioInputStream', 'DISPID_SRCEFalseRecognition',
    'DISPID_SGRSRule', 'SPINTERFERENCE', 'SVP_6',
    'SAFT48kHz16BitMono', 'SpeechFormatType', 'SPFM_OPEN_READWRITE',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SPRsCount', 'SRATopLevel',
    'SPAR_Unknown', 'DISPID_SGRsDynamic', 'SPAR_Medium',
    'tagSPPROPERTYINFO', 'ISpeechRecoResultTimes',
    'DISPID_SGRSTWeight', 'DISPID_SPAStartElementInResult',
    'SPBO_NONE', 'SPSTREAMFORMATTYPE', 'SDTAlternates',
    'SPINTERFERENCE_NOISE', 'DISPID_SLPsItem', 'DISPID_SOTDataKey',
    'SPLO_DYNAMIC', 'SpeechPropertyHighConfidenceThreshold',
    'SITooQuiet', 'SPWORDTYPE', 'DISPID_SAFGuid',
    'ISpeechPhraseAlternate', 'SREPropertyStringChange',
    'SPSERIALIZEDPHRASE', 'DISPID_SRGIsPronounceable',
    'DISPID_SpeechObjectTokens', 'DISPID_SGRClear', 'DISPID_SPRuleId',
    'DISPID_SPIRetainedSizeBytes', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SRStatus', 'STSF_LocalAppData', 'SpMemoryStream',
    'SP_VISEME_6', 'SP_VISEME_7', 'DISPID_SDKSetLongValue',
    'SREStreamStart', 'ISpeechTextSelectionInformation', 'ISpStream',
    'DISPID_SPAsItem', 'SPINTERFERENCE_NONE',
    'DISPID_SRGSetWordSequenceData', 'SASStop', 'SPEI_TTS_BOOKMARK',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpStreamFormatConverter',
    'DISPID_SVEWord', 'DISPID_SRGCmdLoadFromObject', 'SPEI_RESERVED2',
    'DISPID_SRSAudioStatus', 'DISPID_SLPPhoneIds',
    'ISpStreamFormatConverter', 'DISPID_SLPLangId', 'SPEVENT',
    'SpSharedRecognizer', 'eLEXTYPE_PRIVATE15',
    'SRSInactiveWithPurge', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SpeechFileStream', 'DISPID_SpeechPhraseInfo',
    'ISpRecoContext', 'DISPID_SVPause', 'DISPID_SVSpeakCompleteEvent',
    'ISpLexicon', 'DISPID_SGRSTs_NewEnum', 'SAFTGSM610_11kHzMono',
    'eLEXTYPE_PRIVATE16', 'SPEI_PROPERTY_STRING_CHANGE',
    'SP_VISEME_2', 'DISPID_SRCBookmark', 'SRTEmulated',
    'SpeechEngineProperties', 'SPEVENTSOURCEINFO',
    'SPEI_END_SR_STREAM', 'SSFMOpenReadWrite', 'SDKLDefaultLocation',
    'ISpeechMMSysAudio', 'STSF_FlagCreate', 'DISPID_SOTCDefault',
    '_ISpeechVoiceEvents', 'SPAS_RUN',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPWORDPRONUNCIATION', 'DISPID_SVStatus', 'eLEXTYPE_RESERVED7',
    'DISPID_SVSLastResult', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SDKCreateKey', 'SAFT16kHz16BitStereo',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SOTsItem',
    'SpeechEmulationCompareFlags', 'SSTTWildcard',
    'SpeechPropertyResourceUsage', 'DISPID_SPERequiredConfidence',
    'DISPID_SpeechGrammarRules', 'DISPIDSPTSI_SelectionOffset',
    'SPPS_Noun', 'SP_VISEME_15', 'SREStateChange', 'SPWT_LEXICAL',
    'DISPID_SRGRecoContext', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SPPConfidence', 'ISpRecoCategory', 'SAFT22kHz16BitMono',
    'SpeechLexiconType', 'SPSERIALIZEDRESULT',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SRCRequestedUIType',
    'DISPID_SRGReset', 'DISPID_SVSInputWordPosition', 'SPPS_Modifier',
    'DISPID_SpeechRecoResult', 'SECFNoSpecialChars',
    'SAFT11kHz16BitStereo', 'SPEI_RESERVED1', 'SVP_2',
    'SDKLCurrentConfig', 'SPPS_RESERVED3', 'SDTReplacement', 'SVP_21',
    'SPBOOKMARKOPTIONS', 'DISPID_SRGCommit', 'Speech_StreamPos_Asap',
    'DISPID_SVSInputSentenceLength', 'DISPID_SBSWrite',
    'SAFTNonStandardFormat', 'DISPID_SABIBufferSize',
    'SRADefaultToActive', 'DISPID_SPPEngineConfidence',
    'SVSFParseSapi', 'ISpeechObjectToken', 'SAFT8kHz16BitStereo',
    'SP_VISEME_19', 'SPINTERFERENCE_TOOFAST', 'SREFalseRecognition',
    'SpeechAllElements', 'SPSNotOverriden', 'SPEI_SR_PRIVATE',
    'DISPID_SVSInputWordLength', 'SGRSTTWildcard',
    'SAFT48kHz16BitStereo', 'DISPID_SPIRule', 'ISpeechLexiconWords',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPEPronunciation',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SPRs_NewEnum',
    'eLEXTYPE_USER_SHORTCUT', 'SVSFIsXML', 'DISPID_SpeechPhraseRules',
    'SPSHT_OTHER', 'SpeechRecognitionType', 'ISpeechAudioBufferInfo',
    'SPEI_SR_RETAINEDAUDIO', 'SpeechVisemeFeature', 'DISPID_SPEsItem',
    'SpAudioFormat', 'SVEPhoneme', 'SSSPTRelativeToEnd',
    'SDKLCurrentUser', 'SpeechVoiceSkipTypeSentence', 'SPAS_STOP',
    'SPVPRIORITY', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SRRSetTextFeedback', 'DISPIDSPTSI', 'SVP_15',
    'DISPID_SVSVisemeId', 'DISPID_SRCPause', 'ISpeechFileStream',
    'SPPHRASERULE', 'SPEI_ADAPTATION', 'SpeechAudioFormatGUIDText',
    'DISPID_SPPParent', 'eWORDTYPE_ADDED', 'DISPID_SOTCGetDataKey',
    'DISPID_SpeechLexiconProns', 'IInternetSecurityMgrSite',
    'SpeechVisemeType', 'SRSEIsSpeaking',
    'DISPID_SRCSetAdaptationData', 'SPCT_DICTATION',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVEEndInputStream',
    'SRCS_Disabled', 'DISPID_SVPriority',
    'DISPID_SOTMatchesAttributes', 'SGDSActiveWithAutoPause',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SLPType',
    'SPWT_PRONUNCIATION', 'DISPID_SRCEHypothesis',
    'SpeechTokenIdUserLexicon', 'ISpeechWaveFormatEx',
    'eLEXTYPE_PRIVATE8', 'SAFTADPCM_8kHzMono',
    'DISPID_SRSetPropertyNumber', 'DISPID_SVSRunningState',
    'DISPID_SRRSpeakAudio', 'SAFTCCITT_uLaw_8kHzStereo',
    'SpeechLoadOption', 'DISPID_SPIGetDisplayAttributes',
    'SECFIgnoreCase', 'DISPID_SRRTTickCount',
    'DISPID_SpeechObjectToken', 'SpStream',
    'ISpeechLexiconPronunciation', 'DISPID_SPERetainedStreamOffset',
    'SVSFParseSsml', 'DISPID_SVESentenceBoundary',
    'SAFT44kHz16BitStereo', 'DISPID_SRCCreateGrammar',
    'SPPS_RESERVED4', 'DISPID_SpeechObjectTokenCategory',
    'ISpeechRecoResult2', 'SVEPrivate', 'SpeechVoiceEvents',
    'SLODynamic', 'SAFT32kHz8BitStereo', 'ISpPhraseAlt',
    'eLEXTYPE_PRIVATE19', 'SPXRO_SML', 'DISPID_SpeechVoiceEvent',
    'ISpeechPhraseElement', 'SITooLoud', 'SPPHRASE', 'IEnumString',
    'eLEXTYPE_PRIVATE9', 'DISPIDSPTSI_ActiveOffset',
    'SPWORDPRONOUNCEABLE', 'SpeechMicTraining',
    'SWPUnknownWordPronounceable', 'SPDKL_CurrentConfig',
    'eLEXTYPE_PRIVATE2', 'SGDSInactive', 'DISPID_SDKEnumKeys',
    'SPFM_CREATE', 'ISpRecognizer2', 'ISpeechRecognizer',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SBSRead',
    'SAFT32kHz8BitMono', 'SAFTNoAssignedFormat',
    'DISPID_SPIStartTime', 'ISpRecoGrammar2', 'SPEI_MIN_SR',
    'SPRECOSTATE', 'SPRS_ACTIVE', 'SAFT8kHz8BitMono',
    'SSTTTextBuffer', 'SVEViseme', 'DISPID_SVEPhoneme',
    'SVSFUnusedFlags', 'STCInprocHandler', 'DISPID_SRRecognizer',
    'SVESentenceBoundary', 'SRTSMLTimeout', 'SECHighConfidence',
    'SpWaveFormatEx', 'ISpNotifySink', 'DISPID_SPRules_NewEnum',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SpeechLexicon',
    'DISPID_SRCRecognizer', 'DISPID_SAEventHandle',
    'DISPID_SVEViseme', 'SRTAutopause',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SPEAudioSizeTime',
    'DISPID_SDKGetlongValue', 'DISPID_SRCEBookmark',
    'ISpeechResourceLoader', 'DISPID_SWFESamplesPerSec',
    'SpeechRecoContextState', 'SPPS_Noncontent',
    'SAFTCCITT_ALaw_8kHzStereo', 'SAFT11kHz16BitMono', 'DISPID_SPPId',
    'SpeechAddRemoveWord', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SBSFormat',
    'DISPID_SVEStreamStart', 'SVP_16', 'SECLowConfidence', 'SBONone',
    'SpPhoneConverter', 'SAFTADPCM_22kHzStereo', 'DISPID_SGRsItem',
    'DISPID_SGRsCommitAndSave', 'eLEXTYPE_PRIVATE11',
    'SPXMLRESULTOPTIONS', 'DISPID_SGRId', 'DISPID_SMSADeviceId',
    'ISpeechGrammarRuleStateTransition', 'SVSFDefault', 'tagSTATSTG',
    'SRSEDone', 'ISpVoice', 'eLEXTYPE_PRIVATE10',
    'DISPID_SAFSetWaveFormatEx', 'Speech_Max_Pron_Length',
    'DISPID_SRRPhraseInfo', 'SpCompressedLexicon', 'DISPID_SPAsCount',
    'SFTSREngine', 'eLEXTYPE_PRIVATE18', 'DISPID_SPEs_NewEnum',
    'SPPS_NotOverriden', 'DISPID_SVSpeak',
    'SpeechVoiceCategoryTTSRate'
]

_check_version('1.1.14', 1622514407.772483)
